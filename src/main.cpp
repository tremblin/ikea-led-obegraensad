...
//  Screen.test();
  ...
  std::vector<Fade*> fades = { new SplashFade(100), new DropFade(300), new SnakeFade(100), new HorizontalWashFade(100), new CrashFade(100), new VerticalWashFade(100), new NoneFade(300) };
