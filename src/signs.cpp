...
std::vector<int> celsiusSymbol = {
    0x5c, 0x10, 0x10, 0x10, 0x1c };
...
// bitcount=8
std::vector<std::vector<int>> mediumNumbers = {
    {0x1c, 0x22, 0x22, 0x22, 0x22, 0x22, 0x1c}, // 0
    {0x08, 0x18, 0x08, 0x08, 0x08, 0x08, 0x1c}, // 1
    {0x1c, 0x22, 0x02, 0x04, 0x08, 0x10, 0x3e}, // 2
    {0x3c, 0x02, 0x02, 0x1c, 0x02, 0x02, 0x3c}, // 3
    {0x22, 0x22, 0x22, 0x3e, 0x02, 0x02, 0x02}, // 4
    {0x3e, 0x20, 0x20, 0x3c, 0x02, 0x02, 0x3c}, // 5
    {0x1c, 0x20, 0x20, 0x3c, 0x22, 0x22, 0x1c}, // 6
    {0x3e, 0x02, 0x02, 0x04, 0x08, 0x08, 0x08}, // 7
    {0x1c, 0x22, 0x22, 0x1c, 0x22, 0x22, 0x1c}, // 8
    {0x1c, 0x22, 0x22, 0x1e, 0x02, 0x22, 0x1c}  // 9
};

// bitcount=8
std::vector<std::vector<int>> mediumNumbers2 = {
    {0x3c, 0x7e, 0x66, 0x66, 0x66, 0x7e, 0x3c}, // 0
    {0x18, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18}, // 1
    {0x3c, 0x7e, 0x06, 0x1c, 0x30, 0x7e, 0x7e}, // 2
    {0x3c, 0x7e, 0x06, 0x1c, 0x06, 0x7e, 0x3c}, // 3
    {0x66, 0x66, 0x66, 0x7e, 0x06, 0x06, 0x06}, // 4
    {0x7e, 0x7e, 0x60, 0x7c, 0x06, 0x7e, 0x7c}, // 5
    {0x3c, 0x7e, 0x60, 0x7c, 0x66, 0x7e, 0x3c}, // 6
    {0x7e, 0x7e, 0x06, 0x1c, 0x18, 0x18, 0x18}, // 7
    {0x3c, 0x7e, 0x66, 0x1c, 0x66, 0x7e, 0x3c}, // 8
    {0x3c, 0x7e, 0x66, 0x3e, 0x06, 0x7e, 0x3c}  // 9
};
